...
<body>
  <form method="post" action="insert.php">
    <div class="form-group">
      ...
      <div class="col-sm-12">
        <input type="number" value="" class="form-control" name="name" placeholder="ID Peminjam">
      </div>
    </div>
    <div class="form-group">
  ...
  <script type="text/javascript">
    ...
    $(function () {
      $('body').on('click', '.remove', function () {
        ...
        $('.tableAngsuran tbody .num').each(function(i){
          ...
          i++;
          $($(this).find('td')[1]).html('<input type="date" class="form-control" name="tgl_kembali['+ i +']" placeholder="Tanggal Kembali" value= "">');
          $($(this).find('td')[2]).html('<input type="number" class="form-control" name="nom_angsuran['+ i +']" placeholder="Nominal Angsuran" value= "">');
        });
    ...
    function GetDynamicTextBox() {
      return '<td></td>' + '<td></td>' + '<td></td>' + '<td><div class="remove btn-group"><a href="#" class="btn btn-danger"><i class="fa fa-close"></i></a></div></td>';
    }
  </script>
</body>
</html> 